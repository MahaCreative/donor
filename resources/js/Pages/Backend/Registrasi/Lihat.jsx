...
export default function Lihat({ registrasi, errors, golDar, closeModal }) {
    ...
    return (
        <div className='px-3 py-3 capitalize'>
                    ...
                    <div className='flex flex-col gap-y-3 px-3 '>
                        <div className='flex flex-col gap-y-3'>
                            <div>
                                ...
                                <Input defaultValue={data.nama} onChange={onChange} placeholder='Nama Lengkap' name='nama' />
                            </div>
                            <div>
                                <p className='text-white'>Email Pendonor</p>
                                <Input defaultValue={data.email} onChange={onChange} type='email' placeholder='Email' name='' />
                            </div>
                            <div className='flex flex-col md:flex-row gap-3'>
                                <div>
                                    <p className='text-white text-sm'>Status Donor Darah</p>
                                    <Input defaultValue={data.status_proses} />
                                </div>
                                <div>
                                    <p className='text-white text-sm'>Tanggal Donor Darah</p>
                                    <Input defaultValue={moment(data.tanggal).format('DD-MMMM-YYYY')} />
                                </div>
                                <div>
                                    <p className='text-white text-sm'>Golongan Darah</p>
                                    <Input defaultValue={data.gol_darah} />
                                </div>
                                <div>
                                    <p className='text-white text-sm'>Jumlah Darah</p>
                                    <Input defaultValue={data.jumlah_donor} />
                                </div>
                            </div>
                                <div>
                                    <p className='text-white text-sm'>Keterangan</p>
                                    <textarea
                                        onChange={onChange}
                                        name=''
            ...
            </div>) : <p className='text-white'>Data Proses Belum Tersedia</p>}

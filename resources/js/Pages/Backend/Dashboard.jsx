        ...
        <div className='bg-slate-800 h-screen'>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 py-1.5 px-3 gap-2 md:h-[450px] lg:h-[350px]">
                {stok.map((item, id) => (
                    ...
                    <p className='block w-full text-3xl text-white text-center'>Stok Darah</p>
                    <div className="flex justify-between text-white w-full p-2.5 gap-2">
                            <p className='border border-dashed p-2.5 text-4xl font-bold text-center border-white rounded-lg w-1/2'>{ item.darah.golongan_darah}</p>
                            <p className='border border-dashed p-2.5 text-4xl font-bold text-center border-white rounded-lg w-1/2'>{item.stok}</p>
                    </div>
                </Card>
                ))}
            </div>

        ...
        <form action=''>
            <div className='flex flex-col gap-y-2'>
                ...
                <Input
                    ...
                    name='penyelenggara'
                />
                {errors.judul_event && <Input.Error className={'text-white'} errors={errors.judul_event}/>}
                <textarea
                    onChange={onChangeHandler}
                    name='kontent'
                    placeholder='Kontent'
                ...
                ></textarea>
                {errors.kontent && <Input.Error classError={'text-white'} errors={errors.kontent}/>}
                                <textarea
                                    onChange={onChangeHandler}
                                    name='tempat'
                                    ...
                                    className='py-1 px-4 outline-none rounded-md shadow-md backdrop-blur-sm text-gray-900 border border-dashed border-gray-900 focus:outline-none placeholder:text-gray-900 focus:ring focus:ring-gray-700/50 focus:ring-offset-2 focus:shadow-md accent-gray-600 w-full'
                ></textarea>
                {errors.tempat && <Input.Error classError={'text-white'} errors={errors.tempat}/>}
                                <Input
                                    onChange={onChangeHandler}
                                    type='date'
                                    name='tanggal_event'
                ...
                />
                {errors.tanggal_event && <Input.Error classError={'text-white'} errors={errors.tanggal_event}/>}
                                <Input
                                    onChange={onChangeHandler}
                                    type='time'
                                    name='waktu_event'
                ...
                />
                {errors.waktu_event && <Input.Error classError={'text-white'} errors={errors.waktu_event}/>}
                                <Input

    ...
    return (
        <form action='' encType='multipart/form-data'>
            <div className='flex flex-col gap-y-2'>
                ...
                <Input
                    defaultValue={model.penyelenggara}
                    onChange={onChangeHandler}
                ...
                <Input
                    defaultValue={model.tanggal_event}
                    onChange={onChangeHandler}
                    type='date'
                    name='tanggal_event'
                ...
                <Input
                    defaultValue={model.waktu_event}
                    onChange={onChangeHandler}
                    type='time'
                    name='waktu_event'
